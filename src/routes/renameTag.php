...
$app->post('/api/Pocket/renameTag', function ($request, $response) {
    ...
    {
        $data['actions'][$key]['action'] = 'tag_rename';
        $data['actions'][$key]['old_tag'] = $value['oldTag'];
        $data['actions'][$key]['new_tag'] = $value['newTag'];
